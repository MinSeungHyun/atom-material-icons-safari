# Atom Material Icons Plugin for Safari
...
This repository is a fork of [mallowigi/a-file-icon-web](https://github.com/mallowigi/a-file-icon-web).
...
```
cd AtomMaterialIconsSafari\ Extension/Resources
